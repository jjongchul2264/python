document.addEventListener("DOMContentLoaded", () => {
    ...
    function enableActionButtons() {
        const empConfirm = document.getElementById("emp-confirm").checked;
        const manageConfirm = document.getElementById("manage-confirm").checked;

        const disabled = (empConfirm === true || manageConfirm === true);

        document.getElementById("clear-signature").disabled = disabled;
        document.getElementById("save-signatures").disabled = disabled;
        document.getElementById("btn-emp-confirm").disabled = disabled;
        document.getElementById("btn-emp-cancel").disabled = disabled;
    }
    ...
    if (clearButton) {
        clearButton.addEventListener("click", (event) => {
            ...
            document.getElementById("contract-flag").checked = false;
            document.getElementById("emp-confirm").checked = false;
            document.getElementById("manage-confirm").checked = false;
        });
    }
    ...
    // 사용자 확정 처리 버튼 클릭
    document.getElementById("btn-emp-confirm").addEventListener("click", () => {
        // 사용자 확정된 항목 검사
        ...
        if (document.getElementById("manage-confirm").checked) {
            alert("관리자 확정된 항목이 있어 처리가 중단됩니다.");
            return;
        }
    ...
    // 사용자 확정 취소 버튼 클릭
    document.getElementById("btn-emp-cancel").addEventListener("click", () => {
        // 선택된 항목 확인
    ...
    function loadContractPage() {
        ...
        if (deptflag === "1") {
            ...
            iframe.src = `/contract2?code=${employeeCode}&year=${year}`;
